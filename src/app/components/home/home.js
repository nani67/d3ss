        ...
        <div className={`h-screen card-container main h-screen`} style={{ height: '100px', backgroundColor: '#fff' }}>
            ...
            <div className={`h-screen`} style={{ backgroundColor: '#FFCF9D', }}>
                <div className='h-screen' style={{ backgroundColor: '#FFCF9D', }}>
                    ...
                    <div class="flex flex-col sm:flex-row justify-around gap-6 p-4">
  
  <div class="flex flex-col items-center bg-blue-100 p-6 rounded-lg shadow-md w-full sm:w-1/3">
    <div class="text-4xl font-bold text-blue-600 mb-2">150+</div>
    <div class="text-xl font-semibold text-gray-700">Projects Done</div>
  </div>

  <div class="flex flex-col items-center bg-green-100 p-6 rounded-lg shadow-md w-full sm:w-1/3">
    <div class="text-4xl font-bold text-green-600 mb-2">98%</div>
    <div class="text-xl font-semibold text-gray-700">Satisfied Customers</div>
  </div>

  <div class="flex flex-col items-center bg-yellow-100 p-6 rounded-lg shadow-md w-full sm:w-1/3">
    <div class="text-4xl font-bold text-yellow-600 mb-2">4.8/5</div>
    <div class="text-xl font-semibold text-gray-700">Average Ratings</div>
  </div>
